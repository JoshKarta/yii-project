...
use app\models\SampliciousSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * SampliciousController implements the CRUD actions for Samplicious model.
 */
class SampliciousController extends Controller
{
    /**
     * @inheritDoc
     */
    ...
    /**
     * Lists all Samplicious models.
     *
     * @return string
     */
    public function actionIndex()
    {
        $searchModel = new SampliciousSearch();
    ...
    /**
     * Creates a new Samplicious model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return string|\yii\web\Response
     */
    public function actionCreate()
    {
        $model = new Samplicious();
